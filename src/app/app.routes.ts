...
export const routes: Routes = [
  ...
  { path: 'blog', loadComponent: () => import('./pages/novedades/novedades.component').then(m => m.NovedadesComponent) },
  { path: 'blog/:id', loadComponent: () => import('./pages/detalle-novedad/detalle-novedad.component').then(m => m.DetalleNovedadComponent) },
  
  { path: 'novedades', loadComponent: () => import('./pages/novedades/novedades.component').then(m => m.NovedadesComponent) },
  { path: 'novedades/:id', loadComponent: () => import('./pages/detalle-novedad/detalle-novedad.component').then(m => m.DetalleNovedadComponent) }
];
